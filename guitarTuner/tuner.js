...
function repeatOnFrame() {
    ...
    var e = bitCounter / findWaveLength(timeDomainData, window.globk * 24, window.globk * 1200, 10, 10, .016, Math.ceil(10 / window.globk));
    if (e > 0) {
...
function beginAudio(e) {
    ...
    }) : alert("Доступ к микрофону не поддерживается вашим браузером. Попробуйте другой браузер.")
}
var noteArray = [
    [32.703, "D1"],
    [34.648, "C1#"],
